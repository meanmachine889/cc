    ...
    return (
        <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent min-w-full">
            <div className="@container mx-auto max-w-5xl px-6">
                ...
                <Card className="@min-4xl:max-w-full dark:bg-transparent py-0 @min-4xl:grid-cols-3 @min-4xl:divide-x @min-4xl:divide-y-0 mx-auto mt-8 grid max-w-sm divide-y overflow-hidden shadow-zinc-950/5 *:text-center md:mt-16">
                    <div className="group shadow-zinc-950/5 py-7">
